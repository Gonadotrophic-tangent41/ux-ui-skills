...
description: Turn product design work, research, artifacts, notes, and outcomes into a concise, credible UX/UI portfolio case study. Use when asked to write, rewrite, structure, edit, or strengthen a design case study, portfolio project, interview presentation, project summary, or process narrative. Extract evidence, clarify the designer's role and constraints, connect decisions to user and business outcomes, choose meaningful visuals, handle confidential or incomplete results honestly, and produce a scannable story for a target audience. Do not invent research, metrics, ownership, quotes, outcomes, or a linear process that did not happen.
---
